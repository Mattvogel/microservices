...
//ShowUser ...
func (ctrl UserController) ShowUser(c *gin.Context) {

	userID := getUserID(c)

	user, err := userModel.GetProfile(userID)
...
func (ctrl UserController) Login(c *gin.Context) {
	var loginForm forms.LoginFormWrapper
...
func (ctrl UserController) Register(c *gin.Context) {
	...
	var registerForm forms.RegisterFormWrapper
	...
	user, token, err := userModel.Register(registerForm)
